...
# Pide al usuario que ingrese nota, edad y sexo
nota = float(input("Ingrese su nota: "))
edad = int(input("Ingrese su edad: "))
sexo = input("Ingrese su sexo con una 'F' para femenino y una 'M' para masculino: ")

# Indicar si el usuario es aceptado o no dependiendo de las reglas indicadas en el enunciado
